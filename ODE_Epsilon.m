%==========================================================================
% Parameters for 1) inital conditions of d202Hg, DxxxHg for 13 boxes (reservoirs);  
%                2) pre_EMPE, and EMPE Hg emission senarios;
%                3) enrichment factors (isotope fractionation) between 13 boxes (reserviors).
%
...
% d202Hg in per mil
delta_atm_Hg0_0_1  = 0;  % atmospheric d202Hg_GEM
delta_atm_Hg2_0_1  = 0;  % atmospheric d202Hg_OM
delta_soil_0_1     = 0;  % terrestiral d202Hg
delta_occ_Hg0_0_1  = 0;  % coastal ocean d202Hg_dissolved gaseous elemental Hg
delta_occ_Hg2_0_1  = 0;  % coastal ocean d202Hg_dissolved divalent Hg
delta_occ_HgP_0_1  = 0;  % coastal ocean d202Hg_particle bound Hg
delta_ocs_Hg0_0_1  = 0;  % surface ocean d202Hg_dissolved gaseous elemental Hg
delta_ocs_Hg2_0_1  = 0;  % surface ocean d202Hg_dissolved divalent Hg
delta_ocs_HgP_0_1  = 0;  % surface ocean d202Hg_particle bound Hg
delta_oci_Hg0_0_1  = 0;  % subsurface ocean d202Hg_dissolved gaseous elemental Hg
delta_oci_Hg2_0_1  = 0;  % subsurface ocean d202Hg_dissolved divalent Hg
delta_oci_HgP_0_1  = 0;  % subsurface ocean d202Hg_particle bound Hg
delta_ocd_0_1      = 0;  % deep ocean d202Hg_particle bound Hg

% DxxxHg in per mil
delta_atm_Hg0_0_2  = 0;  % atmospheric DxxxHg_GEM
delta_atm_Hg2_0_2  = 0;  % atmospheric DxxxHg_OM
delta_soil_0_2     = 0;  % terrestiral d202Hg
delta_occ_Hg0_0_2  = 0;  % coastal ocean DxxxHg_dissolved gaseous elemental Hg
delta_occ_Hg2_0_2  = 0;  % coastal ocean DxxxHg_dissolved divalent Hg
delta_occ_HgP_0_2  = 0;  % coastal ocean DxxxHg_particle bound Hg
delta_ocs_Hg0_0_2  = 0;  % surface ocean DxxxHg_dissolved gaseous elemental Hg
delta_ocs_Hg2_0_2  = 0;  % surface ocean DxxxHg_dissolved divalent Hg
delta_ocs_HgP_0_2  = 0;  % surface ocean DxxxHg_particle bound Hg
delta_oci_Hg0_0_2  = 0;  % subsurface ocean DxxxHg_dissolved gaseous elemental Hg
delta_oci_Hg2_0_2  = 0;  % subsurface ocean DxxxHg_dissolved divalent Hg
delta_oci_HgP_0_2  = 0;  % subsurface ocean DxxxHg_particle bound Hg
delta_ocd_0_2      = 0;  % deep ocean d202Hg_particle bound Hg
%% Time-dependent natural, EPME Hg isotope (d202Hg and DxxxHg data) emission sources

% Geogenic Hg isotope emissions in per mil
delta_geo_1        = -0.76;          % d202Hg volcanic THg from Sun et al., 2016, Elementa: -0.76+/-0.22
delta_wea_1        = -0.76;          % d202Hg of LIP Hg0 emissions  
delta_LIP_GEM_1    = -0.76;          % d202Hg of LIP Hg0 emissions  
delta_LIP_OM_1     = -0.76;          % d202Hg of LIP Hg2 emissions  
delta_BB_1         = 0.00;           % d202Hg of biomass Hg0 emissions  
delta_submar_1     = -0.76;          % d202Hg of submarine Hg releases

delta_geo_2        = 0.00;           % DxxxHg volcanic THg from Sun et al., 2016, Elementa: 0.05+/-0.06
delta_wea_2        = -0.1*0;         % DxxxHg of LIP Hg0 emissions  
delta_LIP_GEM_2    = -0.1*0;         % DxxxHg of LIP Hg0 emissions
delta_LIP_OM_2     = -0.10*0;        % DxxxHg of LIP Hg2 emissions 
delta_BB_2         = 0.00;           % DxxxHg of biomass Hg0 emissions
delta_submar_2     = 0.00;           % DxxxHg of submarine Hg releases
...
% Note also that Hg2 photoreduction can be +MIF or -MIF. This may lead to substantial difference
...
Eatm_Hg0_occ_1     = 0;          % Hg0 dry deposition to coastal ocean, assuming to be zero
Eatm_Hg2_occ_1     = 0;          % Hg2 dry+wet deposition to coastal ocean,assuming to be zero
...
Eatm_Hg0_occ_2     = 0;          % Hg0 dry deposition to coastal ocean, assuming to be zero
Eatm_Hg2_occ_2     = 0;          % Hg2 dry+wet deposition to coastal ocean,assuming to be zero
Eatm_Hg0_Hg2_2     = -0.25*1;    % Photo-oxidation of Hg0 to Hg2 via Br pathway (Sun et al.,2016, ES&T)
Eatm_Hg2_Hg0_2     = -1.05;     % Aqueous photo-reduction of Hg2 to Hg0 (Zheng et al., 2009, GCA for lowest ratio of 35 ngHg/mgDOC, note not in sunlight but in sumilated sunlight!)
...
Esoil_Hg2_occ_1       = 0;         % Hg2 transfer to ocean margin by river discharge, assming to be zero      
Esoil_HgP_occ_1       = 0;         % HgP transfer to ocean margin by river discharge, assming to be zero   
Esoil_bb_1            = 0;         % Hg0 emission to atmosphere (biomass burning), assming to be zero
Esoil_Hg_m_burial_1     = 0;     % Hg burail
% MIF (DxxxHg)enrichment factor in per mil
Esoil_Hg0_atm_res_2   = 0.2*2.5;     % Hg0 emission to atmosphere (non-photo, Zheng and Hintelmann, 2010a, J Phys. Chem. A), same as Jiskra et al.2015 (ES&T)
Esoil_Hg0_atm_pr_2    = 1*0.5;     % Hg0 emission to atmosphere (photochemical,-SH_cysteine mediated, Zheng and Hintelmann, 2010b, J Phys. Chem. A)
Esoil_Hg0_atm_r_2     = 0;         % Hg0 re-emission to atmosphere (diffusion, Koster van Groos et al., 2013, ES&T)
Esoil_Hg2_occ_2       = 0;         % Hg2 transfer to ocean margin by river discharge, assming to be zero      
Esoil_HgP_occ_2       = 0;         % HgP transfer to ocean margin by river discharge, assming to be zero   
Esoil_bb_2            = 0;         % Hg0 emission to atmosphere (biomass burning), assming to be zero
Esoil_Hg_m_burial_2   = 0;       % Hg burail
%--------------------------------------------------------------------------
% Coastal ocean 
%-------------------------------------------------------------------------- 
% MDF (d202Hg)enrichment factor in per mil
Eocc_Hg0_atm_1      = -0.45;      % Hg0 evasion of supersaturated dissolved gaseous Hg0 from surface seawater (Zheng et al., 2007, JAAS)
Eocc_Hg0_Hg2_po_1   = 0;          % Hg0 oxidation to Hg2 (photochemical), assming to be zero
Eocc_Hg0_Hg2_do_1   = 0;          % Hg0 oxidation to Hg2 (dark), assming to be zero
Eocc_Hg0_Hg2_bo_1   = 0;          % Hg0 oxidation to Hg2 (biotic), assming to be zero
Eocc_Hg2_Hg0_pr_1   = -0.8;       % Aqueous photo-reduction of Hg2 to Hg0 (Zheng et al., 2009, GCA for lowest ratio of 35 ngHg/mgDOC, note not in sunlight but in simulated sunlight!)
Eocc_Hg2_Hg0_br_1   = -0.4;       % Hg2 reduction to Hg0 (biotic), Kritee et al.(2013, ES&T)
Eocc_Hg2_HgP_ad_1   = -0.5;       % Hg2 adsorption to HgP (Wiederhold et al.,2010,ES&T, HgCl2/HgNO3--->Hg(SMe)2)
Eocc_HgP_Hg2_rm_1   = 0;          % HgP remineralization to Hg2, assming to be zero
Eocc_Hg0_ocs_v_1    = 0;          % transport of Hg0 from coastal to surface ocean, assming to be zero
Eocc_Hg2_ocs_v_1    = 0;          % transport of Hg2 from coastal to surface ocean, assming to be zero
Eocc_HgP_ocs_v_1    = 0;          % transport of HgP from coastal to surface ocean assming to be zero
Eocc_HgP_sed_1      = 0;          % HgP sedimentation flux
% MIF (DxxxHg)enrichment factor in per mil   
Eocc_Hg0_atm_2      = 0;          % Hg0 evasion of supersaturated dissolved gaseous Hg0 from surface seawater (Zheng et al., 2007, JAAS)
Eocc_Hg0_Hg2_po_2   = 0;          % Hg0 oxidation to Hg2 (photochemical), assming to be zero
Eocc_Hg0_Hg2_do_2   = 0;          % Hg0 oxidation to Hg2 (dark), assming to be zero
Eocc_Hg0_Hg2_bo_2   = 0;          % Hg0 oxidation to Hg2 (biotic), assming to be zero
Eocc_Hg2_Hg0_pr_2   = -0.1*10;   % Aqueous photo-reduction of Hg2 to Hg0 (Zheng et al., 2009, GCA for lowest ratio of 35 ngHg/mgDOC, note not in sunlight but in simulated sunlight!)
Eocc_Hg2_Hg0_br_2   = 0;          % Hg2 reduction to Hg0 (biotic), Kritee et al.(2013, ES&T)
Eocc_Hg2_HgP_ad_2   = 0;          % Hg2 adsorption to HgP (Wiederhold et al.,2010,ES&T, HgCl2/HgNO3--->Hg(SMe)2)
Eocc_HgP_Hg2_rm_2   = 0;          % HgP remineralization to Hg2, assming to be zero
Eocc_Hg0_ocs_v_2    = 0;          % transport of Hg0 from coastal to surface ocean, assming to be zero
Eocc_Hg2_ocs_v_2    = 0;          % transport of Hg2 from coastal to surface ocean, assming to be zero
Eocc_HgP_ocs_v_2    = 0;          % transport of HgP from coastal to surface ocean assming to be zero
Eocc_HgP_sed_2      = 0;          % HgP sedimentation flux
%--------------------------------------------------------------------------
% Surface ocean 
%--------------------------------------------------------------------------    
% MDF (d202Hg)enrichment factor in per mil
...
Eocs_HgP_Hg2_rm_1   = 0;          % HgP remineralization to Hg2, assming to be zero
Eocs_Hg0_occ_v_1   = 0;           % transport of Hg0 from surface to coastal ocean
Eocs_Hg2_occ_v_1   = 0;           % transport of Hg2 from surface to coastal ocean
Eocs_HgP_occ_v_1   = 0;           % transport of HgP from surface to coastal ocean
% MIF (DxxxHg)enrichment factor in per mil   
...
Eocs_Hg2_Hg0_pr_2   = -0.1*1;     % Aqueous photo-reduction of Hg2 to Hg0 (Zheng et al., 2009, GCA for lowest ratio of 35 ngHg/mgDOC, note not in sunlight but in simulated sunlight!here we decrease this value as both models and obs suggest little MIF in the oceans)  )
...
Eocs_HgP_Hg2_rm_2   = 0;          % HgP remineralization to Hg2, assming to be zero
Eocs_Hg0_occ_v_2   = 0;           % transport of Hg0 from surface to coastal ocean
Eocs_Hg2_occ_v_2   = 0;           % transport of Hg2 from surface to coastal ocean
Eocs_HgP_occ_v_2   = 0;           % transport of HgP from surface to coastal ocean
%--------------------------------------------------------------------------
% Subsurface ocean 
%--------------------------------------------------------------------------
...
Eoci_HgP_Hg2_rm_1   = 0;          % HgP remineralization to Hg2, assuming to be zero
...
Eoci_Hg2_Hg0_pr_2   =  -0.1*1;  % Aqueous photo-reduction of Hg2 to Hg0 (Zheng et al., 2009, GCA for lowest ratio of 35 ngHg/mgDOC, note not in sunlight but in simulated sunlight!)
...
Eoci_HgP_Hg2_rm_2   = 0;          % HgP remineralization to Hg2, assuming to be zero
...
Eocd_HgP_Hg2_rm_1   = 0;          % HgP remineralization to Hg2, assming to be zero
...
Eocd_HgP_Hg2_rm_2   = 0;          % HgP remineralization to Hg2, assming to be zero
...
if sign_type == 1    
    ...
    delta_atm_Hg0_0 = delta_atm_Hg0_0_1; 
    delta_atm_Hg2_0 = delta_atm_Hg2_0_1; 
    delta_soil_0     = delta_soil_0_1;  
    delta_occ_Hg0_0  = delta_occ_Hg0_0_1;  % coastal ocean d202Hg_dissolved gaseous elemental Hg
    delta_occ_Hg2_0  = delta_occ_Hg2_0_1;  % coastal ocean d202Hg_dissolved divalent Hg
    delta_occ_HgP_0  = delta_occ_HgP_0_1;  % coastal ocean d202Hg_particle bound Hg
    delta_ocs_Hg0_0 = delta_ocs_Hg0_0_1;
    delta_ocs_Hg2_0 = delta_ocs_Hg2_0_1;
    delta_ocs_HgP_0 = delta_ocs_HgP_0_1;
    delta_oci_Hg0_0 = delta_oci_Hg0_0_1;
    delta_oci_Hg2_0 = delta_oci_Hg2_0_1;
    delta_oci_HgP_0 = delta_oci_HgP_0_1;
    delta_ocd_0     = delta_ocd_0_1;
    
    %  emission sources 
    delta_geo       = delta_geo_1;
    delta_wea       = delta_wea_1;
    ...
    Eatm_Hg0_occ       = Eatm_Hg0_occ_1;         % Hg0 dry deposition to coastal ocean, assuming to be zero
    Eatm_Hg2_occ       = Eatm_Hg2_occ_1;         % Hg2 dry+wet deposition to coastal ocean,assuming to be zero
    ...
    Esoil_Hg2_occ       = Esoil_Hg2_occ_1;         % Hg2 transfer to ocean margin by river discharge, assming to be zero      
    Esoil_HgP_occ       = Esoil_HgP_occ_1;         % HgP transfer to ocean margin by river discharge, assming to be zero   
    Esoil_bb            = Esoil_bb_1;               % Hg0 emission to atmosphere (biomass burning), assming to be zero  
    Esoil_Hg_m_burial   = Esoil_Hg_m_burial_1;

    
    % Enrichment factors between coastal ocean reservior and others
    Eocc_Hg0_atm      = Eocc_Hg0_atm_1;           % Hg0 evasion of supersaturated dissolved gaseous Hg0 from surface seawater (Zheng et al., 2007, JAAS)
    Eocc_Hg0_Hg2_po   = Eocc_Hg0_Hg2_po_1;          % Hg0 oxidation to Hg2 (photochemical), assming to be zero
    Eocc_Hg0_Hg2_do   = Eocc_Hg0_Hg2_do_1;          % Hg0 oxidation to Hg2 (dark), assming to be zero
    Eocc_Hg0_Hg2_bo   = Eocc_Hg0_Hg2_bo_1;          % Hg0 oxidation to Hg2 (biotic), assming to be zero
    Eocc_Hg2_Hg0_pr   = Eocc_Hg2_Hg0_pr_1;       % Aqueous photo-reduction of Hg2 to Hg0 (Zheng et al., 2009, GCA for lowest ratio of 35 ngHg/mgDOC, note not in sunlight but in simulated sunlight!)
    Eocc_Hg2_Hg0_br   = Eocc_Hg2_Hg0_br_1;       % Hg2 reduction to Hg0 (biotic), Kritee et al.(2013, ES&T)
    Eocc_Hg2_HgP_ad   = Eocc_Hg2_HgP_ad_1;       % Hg2 adsorption to HgP (Wiederhold et al.,2010,ES&T, HgCl2/HgNO3--->Hg(SMe)2)
    Eocc_HgP_Hg2_rm   = Eocc_HgP_Hg2_rm_1;          % HgP remineralization to Hg2, assming to be zero

    Eocc_Hg0_ocs_v    = Eocc_Hg0_ocs_v_1;          % transport of Hg0 from coastal to surface ocean, assming to be zero
    Eocc_Hg2_ocs_v    = Eocc_Hg2_ocs_v_1;          % transport of Hg2 from coastal to surface ocean, assming to be zero
    Eocc_HgP_ocs_v    = Eocc_HgP_ocs_v_1;          % transport of HgP from coastal to surface ocean assming to be zero
    Eocc_HgP_sed      = Eocc_HgP_sed_1;           % HgP sedimentation flux
    ...
    Eocs_HgP_Hg2_rm    = Eocs_HgP_Hg2_rm_1;          % demineralization of HgP to Hg2
    ...
    Eocs_Hg0_occ_v   = Eocs_Hg0_occ_v_1;           % transport of Hg0 from surface to coastal ocean
    Eocs_Hg2_occ_v   = Eocs_Hg2_occ_v_1;           % transport of Hg2 from surface to coastal ocean
    Eocs_HgP_occ_v   = Eocs_HgP_occ_v_1;           % transport of HgP from surface to coastal ocean
    ...
    Eoci_HgP_Hg2_rm    = Eoci_HgP_Hg2_rm_1;          % demineralization of HgP to Hg2
    ...
    Eocd_HgP_Hg2_rm    = Eocd_HgP_Hg2_rm_1;          % demineralization of HgP to Hg2
...
elseif sign_type == 2
    ...
    delta_atm_Hg0_0 = delta_atm_Hg0_0_2; 
    delta_atm_Hg2_0 = delta_atm_Hg2_0_2;
    delta_soil_0     = delta_soil_0_2;  
    delta_occ_Hg0_0  = delta_occ_Hg0_0_2;  % coastal ocean DxxxHg_dissolved gaseous elemental Hg
    delta_occ_Hg2_0  = delta_occ_Hg2_0_2;  % coastal ocean DxxxHg_dissolved divalent Hg
    delta_occ_HgP_0  = delta_occ_HgP_0_2;  % coastal ocean DxxxHg_particle bound Hg
    delta_ocs_Hg0_0 = delta_ocs_Hg0_0_2;
    delta_ocs_Hg2_0 = delta_ocs_Hg2_0_2;
    delta_ocs_HgP_0 = delta_ocs_HgP_0_2;
    delta_oci_Hg0_0 = delta_oci_Hg0_0_2;
    delta_oci_Hg2_0 = delta_oci_Hg2_0_2;
    delta_oci_HgP_0 = delta_oci_HgP_0_2;
    delta_ocd_0     = delta_ocd_0_2;
        
    %  emission sources 
    delta_geo       = delta_geo_2;
    delta_wea       = delta_wea_2;
    ...
    Eatm_Hg0_occ    = Eatm_Hg0_occ_2;         % Hg0 dry deposition to coastal ocean, assuming to be zero
    Eatm_Hg2_occ    = Eatm_Hg2_occ_2;         % Hg2 dry+wet deposition to coastal ocean,assuming to be zero
    % Enrichment factors between  terrestrial reservior and others
    ...
    Esoil_Hg2_occ       = Esoil_Hg2_occ_2;         % Hg2 transfer to ocean margin by river discharge, assming to be zero      
    Esoil_HgP_occ       = Esoil_HgP_occ_2;         % HgP transfer to ocean margin by river discharge, assming to be zero   
    Esoil_bb            = Esoil_bb_2;               % Hg0 emission to atmosphere (biomass burning), assming to be zero
    Esoil_Hg_m_burial   = Esoil_Hg_m_burial_2;
    % Enrichment factors between coastal ocean reservior and others
    Eocc_Hg0_atm      = Eocc_Hg0_atm_2;           % Hg0 evasion of supersaturated dissolved gaseous Hg0 from surface seawater (Zheng et al., 2007, JAAS)
    Eocc_Hg0_Hg2_po   = Eocc_Hg0_Hg2_po_2;          % Hg0 oxidation to Hg2 (photochemical), assming to be zero
    Eocc_Hg0_Hg2_do   = Eocc_Hg0_Hg2_do_2;          % Hg0 oxidation to Hg2 (dark), assming to be zero
    Eocc_Hg0_Hg2_bo   = Eocc_Hg0_Hg2_bo_2;          % Hg0 oxidation to Hg2 (biotic), assming to be zero
    Eocc_Hg2_Hg0_pr   = Eocc_Hg2_Hg0_pr_2;       % Aqueous photo-reduction of Hg2 to Hg0 (Zheng et al., 2009, GCA for lowest ratio of 35 ngHg/mgDOC, note not in sunlight but in simulated sunlight!)
    Eocc_Hg2_Hg0_br   = Eocc_Hg2_Hg0_br_2;       % Hg2 reduction to Hg0 (biotic), Kritee et al.(2013, ES&T)
    Eocc_Hg2_HgP_ad   = Eocc_Hg2_HgP_ad_2;       % Hg2 adsorption to HgP (Wiederhold et al.,2010,ES&T, HgCl2/HgNO3--->Hg(SMe)2)
    Eocc_HgP_Hg2_rm   = Eocc_HgP_Hg2_rm_2;          % HgP remineralization to Hg2, assming to be zero

    Eocc_Hg0_ocs_v    = Eocc_Hg0_ocs_v_2;          % transport of Hg0 from coastal to surface ocean, assming to be zero
    Eocc_Hg2_ocs_v    = Eocc_Hg2_ocs_v_2;          % transport of Hg2 from coastal to surface ocean, assming to be zero
    Eocc_HgP_ocs_v    = Eocc_HgP_ocs_v_2;          % transport of HgP from coastal to surface ocean assming to be zero
    Eocc_HgP_sed      = Eocc_HgP_sed_2;          % HgP sedimentation flux
    % Enrichment factors between surface ocean reservior and others
    ...
    Eocs_HgP_Hg2_rm = Eocs_HgP_Hg2_rm_2;          % demineralization of HgP to Hg2
    ...
    Eocs_Hg0_occ_v   = Eocs_Hg0_occ_v_2;           % transport of Hg0 from surface to coastal ocean
    Eocs_Hg2_occ_v   = Eocs_Hg2_occ_v_2;           % transport of Hg2 from surface to coastal ocean
    Eocs_HgP_occ_v   = Eocs_HgP_occ_v_2;           % transport of HgP from surface to coastal ocean
    ...
    Eoci_HgP_Hg2_rm = Eoci_HgP_Hg2_rm_2;          % demineralization of HgP to Hg2
    ...
    Eocd_HgP_Hg2_rm = Eocd_HgP_Hg2_rm_2;          % demineralization of HgP to Hg2
